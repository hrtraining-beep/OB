const LIFF_ID = '2010372532-0i3JE94q';
    ...
    function repairWholeText(value) {
      const text = applyKnownTextReplacements(String(value || ''));
      if (!/[ÃÂà€‘’“”•–—˜™š›œžŸ]/.test(text)) return text;
      const bytes = [];
      ...
      try {
        const decoded = new TextDecoder('utf-8').decode(new Uint8Array(bytes));
        return /[\u0E00-\u0E7F]/.test(decoded) ? decoded : repairMojibake(text);
      } catch {
        return repairMojibake(text);
      }
    }
    ...
    function render(html) {
      ...
      root.innerHTML = applyKnownTextReplacements(repairMojibake(html));
    ...
    function renderWebFallback() {
      render(shell('à¹€à¸›à¸´à¸”à¸œà¹ˆà¸²à¸™à¹€à¸§à¹‡à¸šà¸šà¸£à¸²à¸§à¹€à¸‹à¸­à¸£à¹Œ', `
        <div class="note">
          à¸«à¸™à¹‰à¸²à¸™à¸µà¹‰à¹ƒà¸Šà¹‰à¸‡à¸²à¸™à¸ˆà¸£à¸´à¸‡à¸œà¹ˆà¸²à¸™ LINE LIFF à¹€à¸žà¸·à¹ˆà¸­à¸”à¸±à¸ LINE UserID à¸­à¸±à¸•à¹‚à¸™à¸¡à¸±à¸•à¸´<br>
          à¸ªà¸³à¸«à¸£à¸±à¸š HR/Admin à¸ªà¸²à¸¡à¸²à¸£à¸– login à¸œà¹ˆà¸²à¸™ LINE Login à¹€à¸žà¸·à¹ˆà¸­à¹ƒà¸Šà¹‰ dashboard à¸šà¸™à¹€à¸§à¹‡à¸šà¹„à¸”à¹‰
        </div>
        <button type="button" id="webAdminLogin">Login HR Admin à¸”à¹‰à¸§à¸¢ LINE</button>
        <a class="btn" href="https://liff.line.me/2010372532-0i3JE94q">à¹€à¸›à¸´à¸”à¸œà¹ˆà¸²à¸™ LINE LIFF</a>
        <button type="button" class="secondary" id="webPreviewMentor">Preview Mentor à¸šà¸™à¹€à¸§à¹‡à¸š</button>
        <button type="button" class="secondary" id="webPreviewMentee">Preview Mentee à¸šà¸™à¹€à¸§à¹‡à¸š</button>
      ...
      document.getElementById('healthCheckApi').addEventListener('click', async () => {
        ...
        result.textContent = 'à¸à¸³à¸¥à¸±à¸‡à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸š API...';
        try {
    ...
    function formatMonthTitle(value) {
      ...
      if (Number.isNaN(date.getTime())) return 'à¹€à¸”à¸·à¸­à¸™à¸™à¸µà¹‰';
      ...
      return `
        <header class="topbar">
          <div class="topbar-inner">
            ...
            <div class="role-chip">${escapeHtml(label || role)} Â· ${escapeHtml(display)}</div>
    ...
    function renderRegister() {
      ...
      render(shell('à¸¥à¸‡à¸—à¸°à¹€à¸šà¸µà¸¢à¸™à¹€à¸‚à¹‰à¸²à¹ƒà¸Šà¹‰à¸‡à¸²à¸™', `
        <div class="success">
          <strong>à¸¢à¸·à¸™à¸¢à¸±à¸™ LINE à¸ªà¸³à¹€à¸£à¹‡à¸ˆ</strong><br>
          à¸Šà¸·à¹ˆà¸­à¹ƒà¸™ LINE: ${escapeHtml(name)}
        </div>
        <form id="registerForm">
          ...
          <input name="name" required value="${escapeHtml(name)}" placeholder="à¹€à¸Šà¹ˆà¸™ Kitti P.">

          <label>à¹à¸œà¸™à¸</label>
          <input name="department" required placeholder="à¹€à¸Šà¹ˆà¸™ Operations, Marketing, HR">

          <label>à¸•à¸³à¹à¸«à¸™à¹ˆà¸‡</label>
          <input name="position" placeholder="à¹€à¸Šà¹ˆà¸™ Store Manager">

          <label>Company Email</label>
          <input type="email" name="email" required placeholder="name@nosetea.com">

          <button type="submit">à¸šà¸±à¸™à¸—à¸¶à¸à¹à¸¥à¸°à¸œà¸¹à¸à¸šà¸±à¸à¸Šà¸µ LINE</button>
        </form>
      `));
      ...
      document.getElementById('registerForm').addEventListener('submit', async event => {
        ...
        button.textContent = 'à¸à¸³à¸¥à¸±à¸‡à¸šà¸±à¸™à¸—à¸¶à¸...';
        try {
          ...
          button.textContent = 'à¸šà¸±à¸™à¸—à¸¶à¸à¹à¸¥à¸°à¸œà¸¹à¸à¸šà¸±à¸à¸Šà¸µ LINE';
          alert(error.message);
        }
      });
    }
        ...
        return [
          {
            ...
            dueDate: '2026-06-20',
            target: 'Pimchanok S.',
            description: 'à¸›à¸£à¸°à¹€à¸¡à¸´à¸™à¸„à¸§à¸²à¸¡à¹€à¸‚à¹‰à¸²à¹ƒà¸ˆ à¸à¸²à¸£à¸¡à¸µà¸ªà¹ˆà¸§à¸™à¸£à¹ˆà¸§à¸¡ à¹à¸¥à¸°à¸„à¸§à¸²à¸¡à¸žà¸£à¹‰à¸­à¸¡à¸‚à¸­à¸‡ mentee'
          },
          {
            taskId: 'PV-FB2',
            ...
            dueDate: '2026-07-20',
            target: 'Pimchanok S.',
            description: 'à¸•à¸´à¸”à¸•à¸²à¸¡à¸žà¸±à¸’à¸™à¸²à¸à¸²à¸£à¹€à¸žà¸´à¹ˆà¸¡à¹€à¸•à¸´à¸¡à¸«à¸¥à¸±à¸‡à¸œà¹ˆà¸²à¸™à¹€à¸”à¸·à¸­à¸™à¸—à¸µà¹ˆ 2'
          }
        ];
      }
      return [
        {
          ...
          dueDate: '2026-06-29',
          target: 'Self',
          description: 'à¸šà¸±à¸™à¸—à¸¶à¸ 3 à¸ªà¸´à¹ˆà¸‡à¸—à¸µà¹ˆà¹„à¸”à¹‰à¹€à¸£à¸µà¸¢à¸™à¸£à¸¹à¹‰ 2 à¸„à¸§à¸²à¸¡à¸—à¹‰à¸²à¸—à¸²à¸¢ à¹à¸¥à¸° 1 à¸‚à¹‰à¸­à¹€à¸ªà¸™à¸­à¹à¸™à¸°'
        },
        {
          taskId: 'PV-A1',
          ...
          dueDate: '2026-06-15',
          target: 'Self',
          description: 'à¸¢à¸·à¸™à¸¢à¸±à¸™à¸à¸²à¸£à¹€à¸‚à¹‰à¸²à¸£à¹ˆà¸§à¸¡ onboarding session'
        }
      ];
    }
    ...
    function roleNav(role) {
      if (role === 'Mentor') {
        return [
          ...
          ['tasks', 'ðŸ“‹', 'My Tasks'],
          ['mentees', 'ðŸ‘¥', 'Mentees'],
          ['journey', 'ðŸ“…', 'Checkpoints'],
          ['profile', 'ðŸ‘¤', 'Profile']
        ];
      }
      return [
        ['home', 'ðŸ ', 'Home'],
        ['journey', 'ðŸ—º', 'Journey'],
        ['tasks', 'ðŸ“‹', 'Tasks'],
    ...
    function mentorMenteeCards(mentees) {
      return `
        ...
        <div class="grid">
            ...
            <section class="task-card" style="padding:14px">
              <div class="task-head">
                <div>
                  ...
                  <p class="muted" style="margin-top:3px">${escapeHtml(mentee.department || '-')} Â· ${escapeHtml(mentee.position || '-')}</p>
                </div>
          ...
          `).join('') : '<section class="task-card" style="padding:14px"><strong>à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µ mentee à¸—à¸µà¹ˆà¸–à¸¹à¸ assign</strong><p class="muted" style="margin-top:6px">à¹€à¸¡à¸·à¹ˆà¸­à¸ªà¸£à¹‰à¸²à¸‡ group à¹à¸¥à¸° assign mentor à¹à¸¥à¹‰à¸§ à¸£à¸²à¸¢à¸Šà¸·à¹ˆà¸­à¸ˆà¸°à¸‚à¸¶à¹‰à¸™à¸—à¸µà¹ˆà¸™à¸µà¹ˆà¸­à¸±à¸•à¹‚à¸™à¸¡à¸±à¸•à¸´</p></section>'}
        </div>
      `;
    }
    ...
    function portalTabContent(role, user, tasks, options) {
      ...
      if (portalTab === 'tasks') {
        return `<div class="section-title">${role === 'Mentor' ? 'My Pending Evaluation Tasks' : 'My Pending Tasks'}</div><div class="grid">${tasks.length ? tasks.map(task => taskCard(task, role, options.preview)).join('') : '<section class="task-card" style="padding:14px"><strong>à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µà¸‡à¸²à¸™à¸—à¸µà¹ˆà¸•à¹‰à¸­à¸‡à¸—à¸³</strong></section>'}</div>`;
      }
      if (portalTab === 'learning') {
        return `<div class="section-title">Learning Library</div><section class="task-card" style="padding:14px"><strong>Onboarding Materials</strong><p class="muted" style="margin-top:6px">à¸žà¸·à¹‰à¸™à¸—à¸µà¹ˆà¸™à¸µà¹‰à¹€à¸•à¸£à¸µà¸¢à¸¡à¹„à¸§à¹‰à¸ªà¸³à¸«à¸£à¸±à¸šà¸„à¸¹à¹ˆà¸¡à¸·à¸­ à¸§à¸´à¸”à¸µà¹‚à¸­ à¸«à¸£à¸·à¸­à¹€à¸­à¸à¸ªà¸²à¸£à¹€à¸£à¸µà¸¢à¸™à¸£à¸¹à¹‰à¸‚à¸­à¸‡à¹à¸•à¹ˆà¸¥à¸°à¹€à¸”à¸·à¸­à¸™</p></section>`;
      }
      ...
      if (role === 'Mentor') {
        return `
          ...
          <div class="grid">${tasks.filter(task => task.status !== 'Completed').slice(0, 3).map(task => taskCard(task, role, options.preview)).join('') || '<section class="task-card" style="padding:14px"><strong>à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µà¸‡à¸²à¸™à¸—à¸µà¹ˆà¸•à¹‰à¸­à¸‡à¸—à¸³</strong></section>'}</div>
        `;
      }
      return `
        ...
        <div class="grid">${tasks.filter(task => task.status !== 'Completed').slice(0, 2).map(task => taskCard(task, role, options.preview)).join('') || '<section class="task-card" style="padding:14px"><strong>à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µà¸‡à¸²à¸™à¸—à¸µà¹ˆà¸•à¹‰à¸­à¸‡à¸—à¸³</strong></section>'}</div>
      `;
    }
    ...
    function renderPortal(user, tasks = [], options = {}) {
      ...
      const heroCopy = role === 'Mentor'
        ? 'à¸”à¸¹à¸‡à¸²à¸™à¸›à¸£à¸°à¹€à¸¡à¸´à¸™ à¸ªà¹ˆà¸‡ feedback à¹à¸¥à¸°à¸•à¸´à¸”à¸•à¸²à¸¡ mentee à¸—à¸µà¹ˆà¹„à¸”à¹‰à¸£à¸±à¸šà¸¡à¸­à¸šà¸«à¸¡à¸²à¸¢'
        : 'à¸•à¸´à¸”à¸•à¸²à¸¡ checkpoint, session à¹à¸¥à¸° reflection à¹ƒà¸™à¹€à¸ªà¹‰à¸™à¸—à¸²à¸‡ onboarding';
              ...
              <div class="phone-page">
                ${options.preview ? `
                  <div class="preview-banner">
                    à¹‚à¸«à¸¡à¸” Preview à¸ªà¸³à¸«à¸£à¸±à¸š Admin
                    <button class="secondary" id="backAdmin" style="float:right;min-height:28px;padding:4px 9px;border-radius:9px">à¸à¸¥à¸±à¸š Admin</button>
                  </div>
                ` : ''}
                ...
                <section class="mobile-hero-card ${heroClass}">
                  ...
                  <div class="hero-mark">${role === 'Mentor' ? 'âœ“' : 'ðŸ“…'}</div>
                </section>
                ...
                <section class="profile-strip">
                  ...
                  <div>
                    <strong>${escapeHtml(user.name || user.displayName || '')}</strong>
                    <div class="muted">${escapeHtml(user.department || '-')} Â· ${escapeHtml(user.position || role)}</div>
                  </div>
                </section>

                <div class="quick-cards">
                  <div class="quick-card"><span>à¹€à¸”à¸·à¸­à¸™</span><strong>${formatMonthTitle(nextTask.dueDate).replace(' ', '<br>')}</strong></div>
                  <div class="quick-card"><span>à¸£à¸­à¸”à¸³à¹€à¸™à¸´à¸™à¸à¸²à¸£</span><strong>${pending}</strong></div>
                  <div class="quick-card"><span>à¹€à¸ªà¸£à¹‡à¸ˆà¹à¸¥à¹‰à¸§</span><strong>${completed}</strong></div>
                </div>
                <button class="secondary" id="openProgress" style="width:100%;margin-top:12px">à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸š Progress</button>
    ...
    function taskCard(task, role, preview) {
      const primary = role === 'Mentor'
        ? (task.taskType === 'Feedback' ? 'à¹ƒà¸«à¹‰ Feedback' : 'à¹€à¸›à¸´à¸”à¸‡à¸²à¸™')
        : (task.taskType === 'Reflection' ? 'à¸à¸£à¸­à¸ Reflection' : 'à¸¢à¸·à¸™à¸¢à¸±à¸™');
      const typeText = task.taskType || '-';
      const heroTone = task.status === 'Pending' ? 'brown' : (role === 'Mentor' ? 'green' : '');
      const icon = typeText === 'Feedback' ? 'â˜…' : (typeText === 'Attendance' ? 'âœ“' : 'âœŽ');
      const headline = typeText === 'Feedback'
        ? 'à¸£à¸­à¹ƒà¸«à¹‰ Feedback'
        : (typeText === 'Attendance' ? 'à¸¢à¸·à¸™à¸¢à¸±à¸™à¸à¸²à¸£à¹€à¸‚à¹‰à¸²à¸£à¹ˆà¸§à¸¡' : 'à¸–à¸¶à¸‡à¹€à¸§à¸¥à¸²à¸ªà¹ˆà¸‡ Reflection');
      const summaryMid = typeText === 'Attendance' ? 'à¹€à¸•à¹‡à¸¡à¸§à¸±à¸™' : '1 à¸‡à¸²à¸™';
      return `
        <section class="task-card">
          ...
          <div class="task-content">
            ...
            <div class="task-summary-cards">
              <div class="task-summary-card"><span>à¸›à¸£à¸°à¹€à¸ à¸—</span><strong>${escapeHtml(typeText)}</strong></div>
              <div class="task-summary-card"><span>à¸ˆà¸³à¸™à¸§à¸™</span><strong>${escapeHtml(summaryMid)}</strong></div>
              <div class="task-summary-card"><span>à¸à¸³à¸«à¸™à¸”à¸ªà¹ˆà¸‡</span><strong>${formatThaiDate(task.dueDate)}</strong></div>
            </div>
            <div class="detail-list">
              <div class="detail-row"><span>à¸£à¸²à¸¢à¸¥à¸°à¹€à¸­à¸µà¸¢à¸”</span><strong>${escapeHtml(task.description || '-')}</strong></div>
              <div class="detail-row"><span>à¸ªà¸–à¸²à¸™à¸°</span><strong>${escapeHtml(task.status || 'Open')}</strong></div>
            </div>
            <div class="decision-actions">
              <button class="approve" data-task-action="${escapeHtml(task.taskId)}">${escapeHtml(primary)}</button>
              <button class="reject" data-task-action="${escapeHtml(task.taskId)}">à¸”à¸¹à¸£à¸²à¸¢à¸¥à¸°à¹€à¸­à¸µà¸¢à¸”</button>
            </div>
          </div>
        </section>
      `;
          ...
          <section class="panel form-card">
            <div class="panel-body">
              ...
              <div class="quick-cards" style="margin-top:16px">
                <div class="quick-card"><span>à¸—à¸±à¹‰à¸‡à¸«à¸¡à¸”</span><strong>${total}</strong></div>
                <div class="quick-card"><span>à¹€à¸ªà¸£à¹‡à¸ˆà¹à¸¥à¹‰à¸§</span><strong>${completed}</strong></div>
                <div class="quick-card"><span>à¸„à¹‰à¸²à¸‡à¸­à¸¢à¸¹à¹ˆ</span><strong>${pending}</strong></div>
              </div>
                  ...
                  <div class="task-card" style="padding:14px">
                    <div class="task-head">
                      <div>
                        ...
                        <p class="muted" style="margin-top:3px">${escapeHtml(task.taskType)} Â· ${formatThaiDate(task.dueDate)}</p>
                      </div>
                      <span class="pill ${task.status === 'Completed' ? '' : 'warn'}">${escapeHtml(task.status)}</span>
                    </div>
                  </div>
                `).join('') || '<div class="note">à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µ task à¸ªà¸³à¸«à¸£à¸±à¸š progress</div>'}
              </div>
              <button class="secondary" id="backPortal" style="width:100%;margin-top:16px">à¸à¸¥à¸±à¸šà¸«à¸™à¹‰à¸²à¸«à¸¥à¸±à¸</button>
            </div>
          </section>
        </main>
      `);
    ...
    function renderTaskForm(user, task, options = {}) {
      ...
      if (task.taskType === 'Feedback') {
        formBody = `
          ...
          <label>Comment</label>
          <textarea name="comment" placeholder="à¸‚à¹‰à¸­à¹€à¸ªà¸™à¸­à¹à¸™à¸°à¹€à¸žà¸´à¹ˆà¸¡à¹€à¸•à¸´à¸¡"></textarea>
        `;
      } else if (task.taskType === 'Reflection') {
        formBody = `
          <label>3 Learnings</label>
          <textarea name="learnings" required placeholder="à¸ªà¸´à¹ˆà¸‡à¸—à¸µà¹ˆà¹„à¸”à¹‰à¹€à¸£à¸µà¸¢à¸™à¸£à¸¹à¹‰"></textarea>
          <label>2 Challenges</label>
          <textarea name="challenges" required placeholder="à¸ªà¸´à¹ˆà¸‡à¸—à¸µà¹ˆà¸¢à¸±à¸‡à¸—à¹‰à¸²à¸—à¸²à¸¢"></textarea>
          <label>1 Suggestion</label>
          <textarea name="suggestion" required placeholder="à¸‚à¹‰à¸­à¹€à¸ªà¸™à¸­à¹à¸™à¸°"></textarea>
          <label>Need Support</label>
          <textarea name="support" placeholder="à¸­à¸¢à¸²à¸à¹ƒà¸«à¹‰à¸—à¸µà¸¡à¸Šà¹ˆà¸§à¸¢à¸­à¸°à¹„à¸£à¹€à¸žà¸´à¹ˆà¸¡à¹€à¸•à¸´à¸¡"></textarea>
        `;
      } else {
        formBody = `
          <div class="note">
            à¸¢à¸·à¸™à¸¢à¸±à¸™à¸à¸²à¸£à¹€à¸‚à¹‰à¸²à¸£à¹ˆà¸§à¸¡ session à¸™à¸µà¹‰<br>
            à¸§à¸±à¸™à¸—à¸µà¹ˆ: ${formatThaiDate(task.sessionDate || task.dueDate)}<br>
            à¹€à¸§à¸¥à¸²: ${escapeHtml(task.startTime || '-')} - ${escapeHtml(task.endTime || '-')}<br>
            à¸«à¹‰à¸­à¸‡: ${escapeHtml(task.room || '-')}
          </div>
        ...
        <main class="app-shell">
          <section class="panel form-card">
            <div class="panel-body">
              ...
              <div class="detail-list">
                <div class="detail-row"><span>à¸›à¸£à¸°à¹€à¸ à¸—</span><strong>${escapeHtml(task.taskType)}</strong></div>
                <div class="detail-row"><span>à¹€à¸›à¹‰à¸²à¸«à¸¡à¸²à¸¢</span><strong>${escapeHtml(task.target || 'Self')}</strong></div>
                <div class="detail-row"><span>à¸à¸³à¸«à¸™à¸”à¸ªà¹ˆà¸‡</span><strong>${formatThaiDate(task.dueDate)}</strong></div>
                <div class="detail-row"><span>à¸ªà¸–à¸²à¸™à¸°</span><strong>${escapeHtml(task.status)}</strong></div>
              </div>
              <form id="taskForm" class="grid" style="margin-top:16px">
                ${formBody}
                <button type="submit" ${disabled ? 'disabled' : ''}>${disabled ? 'à¸ªà¹ˆà¸‡à¹à¸¥à¹‰à¸§' : 'Submit'}</button>
                <button type="button" class="secondary" id="backPortal">à¸à¸¥à¸±à¸šà¸«à¸™à¹‰à¸²à¸«à¸¥à¸±à¸</button>
              </form>
            </div>
          </section>
        </main>
      ...
      document.getElementById('taskForm').addEventListener('submit', async event => {
        event.preventDefault();
        if (isPreview) {
          alert('Preview mode: à¸Ÿà¸­à¸£à¹Œà¸¡à¸™à¸µà¹‰à¸«à¸™à¹‰à¸²à¸•à¸²à¹€à¸«à¸¡à¸·à¸­à¸™à¸ˆà¸£à¸´à¸‡ à¹à¸•à¹ˆà¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸šà¸±à¸™à¸—à¸¶à¸à¸‚à¹‰à¸­à¸¡à¸¹à¸¥');
          return;
        }
    ...
    async function renderAdmin() {
      render(`${topbar(currentUser)}<main class="app-shell"><section class="panel"><div class="panel-body"><h2>à¸à¸³à¸¥à¸±à¸‡à¹‚à¸«à¸¥à¸” Admin Dashboard...</h2></div></section></main>`);
      try {
          ...
          <main class="app-shell">
            <section class="panel">
              <div class="panel-body">
                ...
                <p class="muted" style="margin-top:4px">à¸ˆà¸±à¸”à¸à¸²à¸£ session, tasks, notifications, templates à¹à¸¥à¸° progress à¸—à¸±à¹‰à¸‡à¸£à¸°à¸šà¸š</p>
    ...
    async function sendPreviewFlex(role) {
      try {
        ...
        alert(`à¸ªà¹ˆà¸‡à¸à¸²à¸£à¹Œà¸” ${role} à¹€à¸‚à¹‰à¸² LINE à¸‚à¸­à¸‡à¸„à¸¸à¸“à¹à¸¥à¹‰à¸§`);
      } catch (error) {
        alert(error.message);
      }
    }
          ...
          <section class="panel">
            <div class="panel-body">
              ...
              <form id="groupForm" class="grid" style="margin-top:14px">
                ...
                <input name="groupName" required placeholder="à¹€à¸Šà¹ˆà¸™ OB June Week 4">
              ...
              <div class="grid" style="margin-top:18px">
                  ...
                  <div class="queue-card">
                    <div class="queue-head">
                      <div>
                        ...
                        <p class="muted" style="margin-top:4px">Start: ${formatThaiDate(group.startDate)} Â· Every ${group.intervalDays} days Â· ${group.totalMonths} months</p>
                ...
                `).join('') || '<div class="note">à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µà¸à¸¥à¸¸à¹ˆà¸¡ onboarding</div>'}
              </div>
            ...
            target.innerHTML = `
              <form id="assignGroupForm" class="inline-form grid">
                ...
                <select name="userIds" multiple size="8" required>
                  ${mentees.map(user => `<option value="${escapeHtml(user.userId)}">${escapeHtml(user.name || user.displayName)} Â· ${escapeHtml(user.department)}</option>`).join('')}
                </select>
                <p class="muted">à¸à¸” Ctrl/Command à¹€à¸žà¸·à¹ˆà¸­à¹€à¸¥à¸·à¸­à¸à¸«à¸¥à¸²à¸¢à¸„à¸™</p>
          ...
          <section class="panel" style="margin-top:16px">
            <div class="panel-body">
              ...
              <div class="grid" style="margin-top:14px">
                  ...
                  <div class="session-card">
                    <div class="session-head">
                      <div>
                        ...
                        <div class="muted">${formatThaiDate(session.sessionDate)} Â· ${escapeHtml(session.startTime || '-')} - ${escapeHtml(session.endTime || '-')} Â· ${escapeHtml(session.room || '-')}</div>
                        <div class="muted" style="margin-top:4px">Group: ${escapeHtml(renderSessionGroupName(session, data))}</div>
                      </div>
                ...
                `).join('') : '<div class="note">à¸¢à¸±à¸‡à¹„à¸¡à¹ˆà¸¡à¸µ Session à¸—à¸µà¹ˆà¸ªà¸£à¹‰à¸²à¸‡à¹„à¸§à¹‰</div>'}
              </div>
            </div>
          </section>
        `;
          ...
          <section class="panel">
            <div class="panel-body">
              ...
              <form id="messageForm" class="grid" style="margin-top:14px">
                ...
                <textarea name="message" required>à¹à¸ˆà¹‰à¸‡à¹€à¸•à¸·à¸­à¸™à¸ˆà¸²à¸ Nose Tea Onboarding: à¸à¸£à¸¸à¸“à¸²à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸šà¸‡à¸²à¸™à¸‚à¸­à¸‡à¸„à¸¸à¸“à¹ƒà¸™ LIFF</textarea>
              ...
              <form id="segmentForm" class="grid" style="margin-top:14px">
                ...
                <textarea name="message" required>à¸à¸£à¸¸à¸“à¸²à¹€à¸›à¸´à¸” LIFF à¹€à¸žà¸·à¹ˆà¸­à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸šà¸‡à¸²à¸™ onboarding à¸‚à¸­à¸‡à¸„à¸¸à¸“</textarea>
        ...
        panel.innerHTML = `
          <section class="panel">
            <div class="panel-body">
              ...
              <p class="muted" style="margin-top:4px">à¸„à¸¥à¸±à¸‡à¸‚à¹‰à¸­à¸„à¸§à¸²à¸¡à¸—à¸µà¹ˆà¹ƒà¸Šà¹‰à¸‹à¹‰à¸³à¸ªà¸³à¸«à¸£à¸±à¸š reminder, session announcement, feedback à¹à¸¥à¸° reflection</p>
                  ...
                  <div class="queue-card">
                    <div class="queue-head">
                      <div>
                        ...
                        <p class="muted" style="margin-top:4px">${escapeHtml(template.templateKey)} Â· ${escapeHtml(template.audience)} Â· ${template.active ? 'Active' : 'Inactive'}</p>
      ...
      if (tab === 'more') {
        panel.innerHTML = `
          <section class="panel">
            <div class="panel-body">
              <h2>More Tools</h2>
              <p class="muted" style="margin-top:4px">à¹€à¸„à¸£à¸·à¹ˆà¸­à¸‡à¸¡à¸·à¸­à¸—à¸”à¸ªà¸­à¸šà¹à¸¥à¸°à¸”à¸¹à¸•à¸±à¸§à¸­à¸¢à¹ˆà¸²à¸‡ à¹à¸¢à¸à¸ˆà¸²à¸à¸«à¸™à¹‰à¸²à¸—à¸³à¸‡à¸²à¸™à¸ˆà¸£à¸´à¸‡à¹€à¸žà¸·à¹ˆà¸­à¸¥à¸”à¸„à¸§à¸²à¸¡à¸ªà¸±à¸šà¸ªà¸™</p>
              <div class="wide-actions">
    ...
    async function boot() {
      try {
        if (!isLineBrowser()) {
          ...
          if (code && state) {
            render(shell('à¸à¸³à¸¥à¸±à¸‡à¹€à¸‚à¹‰à¸²à¸ªà¸¹à¹ˆà¸£à¸°à¸šà¸šà¹€à¸§à¹‡à¸š...', '<div class="note">à¸à¸³à¸¥à¸±à¸‡à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸š LINE Login</div>'));
        ...
        render(shell('à¹€à¸›à¸´à¸”à¸£à¸°à¸šà¸šà¹„à¸¡à¹ˆà¸ªà¸³à¹€à¸£à¹‡à¸ˆ', `<div class="error">${escapeHtml(error.message)}</div>`));
      }
    }
