          ...
          <div class="panel-body">
            ...
            <div class="ops-grid" style="margin-top:14px">
              ...
              <button type="button" class="ops-card" data-jump-tab="employees">
                ...
                <span>Import CSV, verify employee codes, and manage LINE binding safely.</span>
              </button>
                  ...
                  <div class="queue-card">
                    <div class="queue-head">
                      <div>
                        ...
                        <p class="muted" style="margin-top:4px">Mentees: ${assignedMentees.length} · Mentor: ${mentor ? escapeHtml(mentor.name || mentor.displayName) : 'ยังไม่เลือก'} · Open sessions: ${activeSessionsByGroup[group.groupId] || 0}</p>
                      </div>
              ...
              <form id="assignGroupForm" class="inline-form grid">
                <div class="ops-header">
                  <div>
                    ...
                    <p class="muted" style="margin-top:4px">เลือก mentor หลักและ mentee ใน cohort นี้ กดบันทึกแล้วระบบจะเตรียม task ของ session ที่เปิดอยู่ให้ทันที</p>
                  </div>
                  <span class="ops-status">${assignedIds.size} mentees selected</span>
                </div>
            ...
            document.getElementById('assignGroupForm').addEventListener('submit', async event => {
              ...
              try {
                ...
                adminNotice = {
                  ...
                  body: `เลือก mentee ${result.activeMentees || 0} คน · session ที่เปิดอยู่ ${result.openSessions || 0} รายการ · สร้าง task ใหม่ ${result.createdTasks || 0} งาน · อัปเดต task เดิม ${result.updatedTasks || 0} งาน · feedback ที่ย้าย mentor ${result.reassignedFeedback || 0} งาน`,
